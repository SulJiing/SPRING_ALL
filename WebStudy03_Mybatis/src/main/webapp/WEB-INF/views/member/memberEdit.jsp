...
<form method="post">
	<table>
		<tr>
			<th>비밀번호</th>
			<td><input type="text" name="memPass" required class="form-control"/>
				<span class="text-danger">${errors.memPass}</span></td>
		</tr>
		<tr>
			<th>이름</th>
			<td>
				<input type="text" name="memName" value="${member.memName}" class="form-control" readonly/>
		...
		<tr>
			...
			<td><input type="text" name="memRegno1"
				value="${member.memRegno1}" class="form-control" readonly/><span
				class="text-danger">${errors.memRegno1}</span></td>
		</tr>
		<tr>
			<th>주민번호2</th>
			<td><input type="text" name="memRegno2"
				value="${member.memRegno2}" class="form-control" readonly/><span
				class="text-danger">${errors.memRegno2}</span></td>
		</tr>
		<tr>
			<th>생일</th>
			<td><input type="datetime-local" name="memBir" value="${member.memBir}"
				class="form-control" readonly/><span class="text-danger">${errors.memBir}</span></td>
		</tr>
		<tr>
			<th>우편번호</th>
			<td>
