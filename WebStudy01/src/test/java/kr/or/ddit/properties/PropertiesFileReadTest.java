...
class PropertiesFileReadTest {
	...
	void test() throws IOException, URISyntaxException {
		...
		String lodicalPath = "/kr/or/ddit/message/message-common_en.properties";
		URL realPath = ServerTimeServlet.class.getResource(lodicalPath);
		...
		try(
			...
			// 메모리에만 저장되고 파일에 아직 실제로 저장되지 않음
			properties.setProperty("newProp", "newValue"); 
		}
	}
	
	@Test
	void testResorceBundle() {
