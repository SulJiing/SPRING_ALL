...
<head>
<meta charset="UTF-8">
<!-- <meta http-equiv="Refresh" content="5;url=https://www.naver.com"/> 사이트 이동됨 -->
...
<pre>
	1. respnose heaeder : Refresh (동기 요청으로 document를 갱신하는 경우 활용)
		<%--
			response.setIntHeader("Refresh", 1);
		--%>
		
	2. html meta		: http-equiv="Refresh", content="second;locataion..."
